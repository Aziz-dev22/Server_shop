...
BASE_CSS = """
  * { box-sizing: border-box; }
  :root {
    --bg-1:#0a0c16; --bg-2:#11142a; --card:#151933; --card-2:#1a1f42; --border:#282f57;
    --txt:#eef0fb; --txt-dim:#9aa2cc; --accent:#8b7cf6; --accent-2:#5b8cff; --accent-3:#2dd8d8;
    --green:#2ee6a8; --red:#ff5c72; --yellow:#ffc857; --pink:#ff6fb0;
  }
  ...
  .bg-decor::before { width:520px; height:520px; top:-160px; left:-120px; background:radial-gradient(circle, var(--accent), transparent 70%); animation: float1 18s ease-in-out infinite; }
  .bg-decor::after { width:480px; height:480px; bottom:-180px; right:-100px; background:radial-gradient(circle, var(--accent-3), transparent 70%); animation: float2 22s ease-in-out infinite; }
  @keyframes float1 { 0%,100% { transform:translate(0,0); } 50% { transform:translate(60px,40px); } }
  @keyframes float2 { 0%,100% { transform:translate(0,0); } 50% { transform:translate(-50px,-30px); } }
  @keyframes fadeInUp { from { opacity:0; transform:translateY(10px); } to { opacity:1; transform:translateY(0); } }
  .wrap { display:flex; min-height:100vh; position:relative; z-index:1; }
  .sidebar {
    width:256px; background:linear-gradient(180deg, rgba(21,25,51,.9), rgba(10,12,22,.96) 85%);
  ...
  .brand-icon {
    ...
    box-shadow: 0 8px 22px -6px rgba(139,124,246,.7);
  }
  ...
  .nav-link.active {
    background:linear-gradient(90deg, rgba(139,124,246,.28), rgba(91,140,255,.14));
    color:#fff; border-color:rgba(139,124,246,.45); box-shadow: inset 0 0 0 1px rgba(139,124,246,.2), 0 6px 16px -8px rgba(139,124,246,.5);
  }
  ...
  .icon-purple { background:linear-gradient(135deg, #8b7cf6, #6a5cd6); box-shadow:0 6px 16px -6px rgba(139,124,246,.7); }
  .icon-blue   { background:linear-gradient(135deg, #5b8cff, #3a63d8); box-shadow:0 6px 16px -6px rgba(91,140,255,.7); }
  .icon-teal   { background:linear-gradient(135deg, #2dd8d8, #17a3a8); box-shadow:0 6px 16px -6px rgba(45,216,216,.6); }
  ...
  .icon-pink   { background:linear-gradient(135deg, #ff6fb0, #d94f8c); box-shadow:0 6px 16px -6px rgba(255,111,176,.6); }
  .icon-red    { background:linear-gradient(135deg, #ff5c72, #d93a52); box-shadow:0 6px 16px -6px rgba(255,92,114,.6); }
  .card {
    background:linear-gradient(165deg, var(--card), var(--card-2) 260%);
    border-radius:18px; padding:22px 24px; margin-bottom:20px; border:1px solid var(--border);
    box-shadow: 0 10px 30px -16px rgba(0,0,0,.55); transition: box-shadow .2s ease, transform .2s ease;
    animation: fadeInUp .4s ease;
  }
  .card:hover { box-shadow: 0 16px 40px -18px rgba(0,0,0,.65); }
  ...
  .btn {
    ...
    color:#fff; border:none; padding:10px 20px; border-radius:11px; font-size:13.5px; font-weight:700;
  ...
  .btn:hover { transform: translateY(-2px); filter:brightness(1.08); box-shadow: 0 12px 26px -8px rgba(139,124,246,.8); }
  .btn:active { transform: translateY(0); }
  .btn.small { padding:6px 12px; font-size:12px; margin:2px; box-shadow:none; border-radius:8px; }
  .btn.red { background:linear-gradient(135deg, #ff7a8c, var(--red)); box-shadow:0 8px 20px -8px rgba(255,92,114,.6); }
  .btn.green { background:linear-gradient(135deg, #4cf0b8, var(--green)); box-shadow:0 8px 20px -8px rgba(46,230,168,.6); }
  .btn.gray { background:linear-gradient(135deg, #565f8f, #3a4166); box-shadow:none; }
  input, select, textarea {
    background:rgba(10,12,22,.6); border:1px solid var(--border); color:var(--txt); padding:11px 13px;
  ...
  input:focus, select:focus, textarea:focus { outline:none; border-color:var(--accent); box-shadow: 0 0 0 3px rgba(139,124,246,.15); }
  ...
  .stat-box {
    background:linear-gradient(165deg, var(--card), var(--card-2)); border:1px solid var(--border); border-radius:18px;
    padding:20px 24px; min-width:165px; position:relative; overflow:hidden; box-shadow: 0 10px 30px -16px rgba(0,0,0,.55);
  ...
  .login-box {
    background:linear-gradient(165deg, var(--card), var(--card-2)); padding:40px; border-radius:22px; width:350px;
    border:1px solid var(--border); box-shadow: 0 24px 70px -20px rgba(0,0,0,.65); animation: fadeInUp .4s ease;
  }
"""
