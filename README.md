...
نیازی به دانلود دستی فایل‌ها نیست. کافیست روی یک سرور اوبونتو (Ubuntu 22.04 یا 24.04) این یک خط را اجرا کنید — کد مستقیماً از گیت‌هاب پروژه دانلود و نصب می‌شود:
...
- برای بروزرسانی ربات در آینده (وقتی کد در گیت‌هاب تغییر کرد)، فقط همان دستور نصب یک‌خطی را دوباره اجرا کنید؛ فایل `.env` و دیتابیس شما دست‌نخورده باقی می‌مانند و فقط کد بروزرسانی می‌شود.
